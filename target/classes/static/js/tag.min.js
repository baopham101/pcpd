/**
 * Tagify (v3.20.0) - tags input component
 * By Yair Even-Or
...
!function (t, e) {
    ...
    var g = {
        init: function () {
            ...
            var e, i, s, n = this, a = this.settings, l = window.getSelection(),
                d = "mix" == a.mode && !a.enforceWhitelist, c = !a.whitelist || !a.whitelist.length,
                h = "manual" == a.dropdown.position;
            if ((!c || d || a.templates.dropdownItemNoMatch) && !1 !== a.dropdown.enable && !this.state.isLoading) {
                if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems.call(this, t), t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), a.templates.dropdownItemNoMatch && (s = a.templates.dropdownItemNoMatch.call(this, {value: t}))), !s) {
                    if (this.suggestedListItems.length) t && d && !this.state.editing.scope && !o(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({value: t}); else {
            ...
            var e = this, i = this.DOM, s = i.scope, n = i.dropdown,
            ...
            if ("manual" != this.settings.dropdown.position) {
                var e, i, s, n, a, o, r, l = this.DOM.dropdown, d = document.documentElement.clientHeight,
            ...
            binding: function () {
                ...
                onKeyDown: function (t) {
                    var e = this.DOM.dropdown.querySelector("[class$='--active']"), i = e;
                    switch (t.key) {
                        case"ArrowDown":
                        case"ArrowUp":
                        case"Down":
                        ...
                        case"Tab":
                            if ("mix" != this.settings.mode && i && !this.settings.autoComplete.rightKey && !this.state.editing) {
                                t.preventDefault();
                                var n = i.getAttribute("tagifySuggestionIdx"), a = n ? this.suggestedListItems[+n] : "";
            ...
            var e = this, i = this.settings.dropdown, n = i.clearOnSelect, a = i.closeOnSelect;
            if (!t) return this.addTags(this.input.value, !0), void (a && this.dropdown.hide.call(this));
            var o = t.getAttribute("tagifySuggestionIdx"),
                r = (o ? this.suggestedListItems[+o] : "") || this.input.value;
            if (this.trigger("dropdown:select", {
                data: r,
                elm: t
            }), this.state.editing ? this.onEditTagDone(this.state.editing.scope, s(s(s({}, this.state.editing.scope.__tagifyTagData), {}, {value: r.value}, r instanceof Object ? r : {}), {}, {__isValid: !0})) : this.addTags([r], n), setTimeout((function () {
            ...
            var e, i, s, n, a, o = this, l = this.settings, d = l.dropdown, c = [], g = l.whitelist,
                u = d.maxItems || 1 / 0, p = d.searchKeys, f = 0;
            ...
            for (a = d.caseSensitive ? "" + t : ("" + t).toLowerCase(); f < g.length && (e = g[f] instanceof Object ? g[f] : {value: g[f]}, d.fuzzySearch ? (s = p.reduce((function (t, i) {
                return t + " " + (e[i] || "")
            }), "").toLowerCase(), i = m(d.accentedSearch ? h(s) : s, a)) : i = p.some((function (t) {
                var i = "" + (e[t] || "");
            ...
            return t.map((function (t, i) {
                ...
                var s = e.settings.dropdown.mapValueTo, n = s ? "function" == typeof s ? s(t) : t[s] : t.value,
    ...
    var p = {
        customBinding: function () {
            ...
            var t, e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], i = this.events.callbacks,
            ...
            onFocusBlur: function (t) {
                var e = t.target ? this.trim(t.target.textContent) : "", i = this.settings, s = t.type,
                    n = i.dropdown.enabled >= 0, a = {relatedTarget: t.relatedTarget},
                    o = this.state.actions.selectOption && (n || !i.dropdown.closeOnSelect),
                    r = this.state.actions.addNew && n, l = window.getSelection();
                if ("blur" == s) {
                ...
                var e = this, i = this.trim(t.target.textContent);
                    ...
                    switch (t.key) {
                        ...
                        case"Backspace":
                            ...
                            var s = document.getSelection(),
                                n = "Delete" == t.key && s.anchorOffset == s.anchorNode.length,
                                a = 1 == s.anchorNode.nodeType || !s.anchorOffset && s.anchorNode.previousElementSibling,
                                o = l(this.DOM.input.innerHTML), r = this.getTagElms();
                            if (3 == s.anchorNode.nodeType && !s.anchorNode.nodeValue && s.anchorNode.previousElementSibling && t.preventDefault(), (a || n) && !this.settings.backspace) return void t.preventDefault();
                            setTimeout((function () {
                                if (l(e.DOM.input.innerHTML).length >= o.length && (e.removeTags(s.anchorNode.previousElementSibling), e.fixFirefoxLastTagNoCaret(), 2 == e.DOM.input.children.length && "BR" == e.DOM.input.children[1].tagName)) return e.DOM.input.innerHTML = "", e.value.length = 0, !0;
                                e.value = [].map.call(r, (function (t, i) {
                ...
                s.isValid = this.validateTag({value: e}), this.trigger("input", s), this.input.value != e && (this.input.set.call(this, e, !1), -1 != e.search(this.settings.delimiters) ? this.addTags(e) && this.input.set.call(this) : this.settings.dropdown.enabled >= 0 && this.dropdown[i ? "show" : "hide"].call(this, e))
            }, onMixTagsInput: function (t) {
                var e, i, s, n, a, o, r, l, d, h = this, g = this.settings, u = this.value.length,
                    p = this.getTagElms(), f = [].map.call(p, (function (t) {
                        return h.tagData(t).value
                    }));
                if (this.value.slice().forEach((function (t) {
                    t.readonly && !f.includes(t.value) && h.injectAtCaret(h.createTagElem(t), window.getSelection().getRangeAt(0))
                })), p.length != u) return this.value = [].map.call(this.getTagElms(), (function (t) {
                ...
                if (window.getSelection && (r = window.getSelection()).rangeCount > 0 && 3 == r.anchorNode.nodeType) {
                    if ((e = r.getRangeAt(0).cloneRange()).collapse(!0), e.setStart(r.focusNode, 0), n = (i = e.toString().slice(0, e.endOffset)).split(g.pattern).length - 1, (s = i.match(g.pattern)) && (a = i.slice(i.lastIndexOf(s[s.length - 1]))), a) {
                        if (this.state.actions.ArrowLeft = !1, this.state.tag = {
                            prefix: a.match(g.pattern)[0],
                            value: a.replace(g.pattern, "")
                        }, this.state.tag.baseOffset = r.baseOffset - this.state.tag.value.length, d = this.state.tag.value.match(g.delimiters)) return this.state.tag.value = this.state.tag.value.replace(g.delimiters, ""), this.state.tag.delimiters = d[0], this.addTags(this.state.tag.value, g.dropdown.clearOnSelect), void this.dropdown.hide.call(this);
                        ...
                        (l || n < this.state.mixMode.matchedPatternCount) && (o = !1)
                    } else this.state.flaggedTags = {};
                    this.state.mixMode.matchedPatternCount = n
                }
                setTimeout((function () {
                    h.update({withoutChangeEvent: !0}), h.trigger("input", c({}, h.state.tag, {textContent: h.DOM.input.textContent})), h.state.tag && h.dropdown[o ? "show" : "hide"].call(h, h.state.tag.value)
                }), 10)
                ...
                var s = t.closest("." + this.settings.classNames.tag), n = this.getNodeIndex(s), a = this.tagData(s),
                    o = this.input.normalize.call(this, t), r = s.innerHTML != s.__tagifyTagData.__originalHTML,
                ...
                r || !0 !== t.originalIsValid || (l = !0), s.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l), a.__isValid = l, s.title = !0 === l ? a.title || a.value : l, o.length >= this.settings.dropdown.enabled && (this.state.editing.value = o, this.dropdown.show.call(this, o)), this.trigger("edit:input", {
                    tag: s,
                    index: n,
                    data: c({}, this.value[n], {newValue: o}),
                ...
                if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t)) {
                    var i = this.settings, s = t.closest("." + i.classNames.tag),
                        n = this.input.normalize.call(this, t), a = this.tagData(s).__originalData,
                        o = c({}, a, e({}, i.tagTextProp, n)), r = s.innerHTML != s.__tagifyTagData.__originalHTML,
                ...
                var e, i, s = t.target.closest("." + this.settings.classNames.tag), n = this.settings;
    ...
    function f(t, e) {
        return t ? t.previousElementSibling && t.previousElementSibling.classList.contains("tagify") ? (console.warn("Tagify: ", "input element is already Tagified", t), this) : (this.isFirefox = "undefined" != typeof InstallTrigger, this.isIE = window.document.documentMode, this.applySettings(t, e || {}), this.state = {
            editing: !1,
            actions: {},
            mixMode: {},
            dropdown: {},
            flaggedTags: {}
        }, this.value = [], this.listeners = {}, this.DOM = {}, c(this, new this.EventDispatcher(this)), this.build(t), this.getCSSVars(), this.loadOriginalValues(), this.events.customBinding.call(this), this.events.binding.call(this), void (t.autofocus && this.DOM.input.focus())) : (console.warn("Tagify: ", "input element not found", t), this)
    }
    ...
    return f.prototype = {
        ...
        templates: {
            wrapper: function (t, e) {
                ...
                var e = t.dropdown, i = "manual" == e.position, s = "".concat(t.classNames.dropdown);
        ...
        getCaretGlobalPosition: function () {
            ...
            if (t.rangeCount) {
                var e, i, s = t.getRangeAt(0), n = s.startContainer, a = s.startOffset;
        ...
        loadOriginalValues: function (t) {
            ...
            if (t = t || (i.mixMode.integrated ? this.DOM.input.textContent : this.DOM.originalInput.value)) if (this.removeAllTags(), "mix" == i.mode) this.parseMixTags(t.trim()), (e = this.DOM.input.lastChild) && "BR" == e.tagName || this.DOM.input.insertAdjacentHTML("beforeend", "<br>"); else {
                try {
        ...
        EventDispatcher: function (e) {
            ...
            }, this.trigger = function (s, n) {
                var a;
                if (s) if (e.settings.isJQueryPlugin) "remove" == s && (s = "removeTag"), jQuery(e.DOM.originalInput).triggerHandler(s, [n]); else {
                    try {
                        var o = c({}, "object" === t(n) ? n : {value: n});
                        if (o.tagify = this, n instanceof Object) for (var r in n) n[r] instanceof HTMLElement && (o[r] = n[r]);
        ...
        editTag: function (t, e) {
            ...
            var a = n(), o = this.getNodeIndex(t), r = this.tagData(t), l = this.events.callbacks, d = this, h = !0;
            if (a) {
            ...
            value: "", set: function () {
                ...
                suggest: function (t) {
                    if (this.settings.autoComplete.enabled) {
                        ...
                        var e = t.value ? "" + t.value : "", i = e.substr(0, this.input.value.length).toLowerCase(),
        ...
        getWhitelistItem: function (t, e, i) {
            e = e || "value";
            var s, n = this.settings, a = (i = i || n.whitelist, n.dropdown.caseSensitive);
            return i.some((function (i) {
                var n = "string" == typeof i ? i : i[e];
                if (o(n, t, a)) return s = "string" == typeof i ? {value: i} : i, !0
        ...
        normalizeTags: function (t) {
            var i = this, s = this.settings, a = s.whitelist, o = s.delimiters, r = s.mode, l = s.tagTextProp, d = [],
                c = !!a && a[0] instanceof Object, h = t instanceof Array, g = function (t) {
            ...
            return c && (t.forEach((function (t) {
                var e = d.map((function (t) {
                    return t.value
                })), s = i.dropdown.filterListItems.call(i, "").filter((function (t) {
        ...
        parseMixTags: function (t) {
            var e = this, i = this.settings, s = i.mixTagsInterpolator, n = i.duplicates, a = i.transformTag,
                o = i.enforceWhitelist, r = i.maxTags, l = [];
            return t = t.split(s[0]).map((function (t, i) {
                var d, c, h = t.split(s[1]), g = h[0], u = l.length == r;
                try {
                    if (g == +g) throw Error;
                    d = JSON.parse(g)
                } catch (t) {
                ...
                if (u || !(h.length > 1) || o && !e.isTagWhitelisted(d.value) || !n && e.isTagDuplicate(d.value)) {
                    if (t) return i ? s[0] + t : t
                } else a.call(e, d), c = e.createTagElem(d), l.push(d), c.classList.add(e.settings.classNames.tagNoAnimation), h[0] = c.outerHTML, e.value.push(d);
                return h.join("")
            ...
            })), this.update({withoutChangeEvent: !0}), t
        },
        replaceTextWithNode: function (t, e) {
            if (this.state.tag || e) {
                e = e || this.state.tag.prefix + this.state.tag.value;
                var i, s, n = window.getSelection(), a = n.anchorNode,
        ...
        addEmptyTag: function (t) {
            var e = c({value: ""}, t || {}), i = this.createTagElem(e);
            this.tagData(i, e), this.appendTag(i), this.editTag(i, {skipValidation: !0})
        },
        addTags: function (t, e) {
            var i = this,
                s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.settings.skipInvalid, n = [],
                a = this.settings;
        ...
        addMixTags: function (t) {
            var e, i = this, s = this.settings, n = this.state.tag.delimiters;
        ...
        reCheckInvalidTags: function () {
            var t = this, e = this.settings, i = ".".concat(e.classNames.tag, ".").concat(e.classNames.tagNotAllowed),
                s = this.DOM.scope.querySelectorAll(i);
            [].forEach.call(s, (function (e) {
                var i = t.tagData(e), s = e.getAttribute("title") == t.TEXTS.duplicate, n = !0 === t.validateTag(i);
        ...
        removeTags: function (t, e, i) {
            ...
            t = t && t instanceof HTMLElement ? [t] : t instanceof Array ? t : t ? [t] : [this.getLastTag()], s = t.reduce((function (t, e) {
                return e && "string" == typeof e && (e = n.getTagElmByValue(e)), e && t.push({
                    ...
                    data: n.tagData(e, {__removed: !0})
                }), t
            }), []), i = "number" == typeof i ? i : this.CSSVars.tagHideTransition, "select" == this.settings.mode && (i = 0, this.input.set.call(this)), 1 == s.length && s[0].node.classList.contains(this.settings.classNames.tagNotAllowed) && (e = !0), s.length && this.settings.hooks.beforeRemoveTag(s, {tagify: this}).then((function () {
                function t(t) {
        ...
        update: function (t) {
            var e, i, s = this.DOM.originalInput, n = (t || {}).withoutChangeEvent,
